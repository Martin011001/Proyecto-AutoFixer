              ...
              onPressed: () async {
                setState(() {
                  _modelError = modelController.text.isEmpty ||
                      ...
                      ? 'El modelo debe tener aunque sea 3 caracteres'
                      : null;
                  _brandError = brandController.text.isEmpty ||
                          brandController.text.length < 3
                      ? 'La marca debe tener aunque sea 3 caracteres'
                      : null;
                  _licensePlateError = licensePlateController.text.isEmpty ||
                      ...
                      : null;
                  _yearError = yearController.text.isEmpty ||
                          !RegExp(r'^(19[0-9]{2}|20[0-2][0-9]|202[0-4])$').hasMatch(yearController.text)
                ...
                try {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Error al actualizar el vehículo: $e'),
                    ),
                  );
                } finally {
                  setState(() {
            ...
            TextButton(
              onPressed: () async {
                ...
                try {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Error al agregar el vehículo: $e'),
                    ),
                  );
                } finally {
                  setState(() {
