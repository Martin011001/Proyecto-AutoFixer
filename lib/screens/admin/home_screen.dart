    ...
    return const HomeScreenBase(
      ...
      buttons: [
        NavigationButton(
          ...
          icon: Icon(Icons.bar_chart, size: 90, color: Colors.white),
        ),
        NavigationButton(
          text: 'Turnos',
        ...
        NavigationButton(
          ...
          icon: Icon(Icons.person, size: 90, color: Colors.white),
        ),
        NavigationButton(
          text: 'Servicios',
          route: '/administrador/servicios',
          icon: Icon(Icons.local_hospital, size: 90, color: Colors.white),
        ),
        NavigationButton(
          text: 'Horas de negocio',
          route: '/administrador/business-hours',
          icon: Icon(Icons.access_time, size: 90, color: Colors.white),
        ),
      ],
    );
  }
